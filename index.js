   ...
   try {
          ...
          if(args[0].toLowerCase() == "10"){
            ...
            eg.communicator.sendMessage(DANG1172s_BOT8_ID, msg);
            eg.communicator.sendMessage(DANG1172s_BOT9_ID, msg);
            eg.communicator.sendMessage(DANG1172s_BOT10_ID, msg);
          }
          if(args[1].toLowerCase() == "11"){
            eg.communicator.sendMessage(DANG1172s_BOT1_ID, msg);
            eg.communicator.sendMessage(DANG1172s_BOT2_ID, msg);
            eg.communicator.sendMessage(DANG1172s_BOT3_ID, msg);
            eg.communicator.sendMessage(DANG1172s_BOT4_ID, msg);
            ...
            eg.communicator.sendMessage(DANG1172s_BOT9_ID, msg);
            eg.communicator.sendMessage(DANG1172s_BOT10_ID, msg);
            eg.communicator.sendMessage(DANG1172s_BOT11_ID, msg);
          }
          if(args[1].toLowerCase() == "12"){
            eg.communicator.sendMessage(DANG1172s_BOT1_ID, msg);
            eg.communicator.sendMessage(DANG1172s_BOT2_ID, msg);
            eg.communicator.sendMessage(DANG1172s_BOT3_ID, msg);
            eg.communicator.sendMessage(DANG1172s_BOT4_ID, msg);
            ...
            eg.communicator.sendMessage(DANG1172s_BOT10_ID, msg);
            eg.communicator.sendMessage(DANG1172s_BOT11_ID, msg);
            eg.communicator.sendMessage(DANG1172s_BOT12_ID, msg);
          }
          if(args[1].toLowerCase() == "13"){
            eg.communicator.sendMessage(DANG1172s_BOT1_ID, msg);
            eg.communicator.sendMessage(DANG1172s_BOT2_ID, msg);
            eg.communicator.sendMessage(DANG1172s_BOT3_ID, msg);
            eg.communicator.sendMessage(DANG1172s_BOT4_ID, msg);
            ...
            eg.communicator.sendMessage(DANG1172s_BOT11_ID, msg);
            eg.communicator.sendMessage(DANG1172s_BOT12_ID, msg);
            eg.communicator.sendMessage(DANG1172s_BOT13_ID, msg);
          }
          if(args[1].toLowerCase() == "14"){
            eg.communicator.sendMessage(DANG1172s_BOT1_ID, msg);
            eg.communicator.sendMessage(DANG1172s_BOT2_ID, msg);
            eg.communicator.sendMessage(DANG1172s_BOT3_ID, msg);
            eg.communicator.sendMessage(DANG1172s_BOT4_ID, msg);
            ...
            eg.communicator.sendMessage(DANG1172s_BOT12_ID, msg);
            eg.communicator.sendMessage(DANG1172s_BOT13_ID, msg);
            eg.communicator.sendMessage(DANG1172s_BOT14_ID, msg);
          }
          if(args[1].toLowerCase() == "15"){
            var msg = "!leave"
            eg.communicator.sendMessage(DANG1172s_BOT_ID, msg);
            eg.communicator.sendMessage(DANG1172s_BOT1_ID, msg);
              eg.communicator.sendMessage(DANG1172s_BOT2_ID, msg);
              eg.communicator.sendMessage(DANG1172s_BOT3_ID, msg);
              eg.communicator.sendMessage(DANG1172s_BOT4_ID, msg);
              ...
              eg.communicator.sendMessage(DANG1172s_BOT13_ID, msg);
              eg.communicator.sendMessage(DANG1172s_BOT14_ID, msg);
              eg.communicator.sendMessage(DANG1172s_BOT15_ID, msg);
          }
